                        ...
                        try {
                            for (Profile profile : profiles) {
                                ...
                                if (!StringUtils.equals(profileId, masterProfileId)) {
                                    ...
                                    for (Event profileevent : events) {
                                        if(!profileevent.getItemId().equals(event.getItemId())) {
                                            persistenceService.update(profileevent.getItemId(), profileevent.getTimeStamp(), Event.class, "profileId", anonymousBrowsing ? null : masterProfileId);
                                        }
                                    }
